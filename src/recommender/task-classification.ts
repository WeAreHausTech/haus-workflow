/**
 * Task-intent classification: maps a free-text task description and a rule's catalog
 * metadata onto a shared set of semantic intents, used to route `haus context`.
 */
