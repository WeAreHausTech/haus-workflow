...
- **`haus.workspace.yaml`** and **`repos.manifest.json`** — describe a *multi-repo workspace* (which repos exist, how they relate). About **what repos exist**. See [Workspace mode](/docs/haus-workflow/workspace) for the full picture; they are not interchangeable with each other either.
