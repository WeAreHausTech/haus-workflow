...
- [Workspace mode](./workspace) — working across multiple repos
- [Slash commands](./slash-commands)
- [Claude Code in Action](./claude-code-guide)
- [Architecture](./architecture) — pipeline, catalog fetch, lock file, security model
- [Troubleshooting & FAQ](./troubleshooting)
- [Haus Workflow Catalog](./catalog) — skills, agents, templates (122 items)
