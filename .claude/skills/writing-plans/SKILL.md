...
See `.claude/skills/shared/task-format-reference.md` for the full granularity guide.
...
See `.claude/skills/shared/task-format-reference.md` → "User-Thrown Gates" for the full metadata schema with all six gate-related keys (`userGate`, `tags`, `requiresUserSpecification`, `gateScope`, `failurePolicy`, `subagentBrief`), and `docs/user-gate-flow.md` for the end-to-end flow.
...
See `.claude/skills/shared/task-format-reference.md` for the full metadata schema.
