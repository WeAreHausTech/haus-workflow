...
const MONOREPO_RULES = new Set(['haus.nx21-monorepo-patterns', 'haus.turbo-monorepo-patterns'])
...
const cases = [
  ...
  },
  {
    ...
    task: 'create new lib',
    forbid: new Set(['haus.react19-patterns', 'haus.typescript5-patterns', 'haus.nextjs-patterns']),
