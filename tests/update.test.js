...
test("update check and apply create backup", () => {
  ...
  writeFileSync(path.join(temp, ".haus-workflow/haus.lock.json"), JSON.stringify([{ id: "x", type: "skill", source: "haus", version: "0.2.0", hash: "sha256-old", installMode: "copied", paths: [] }], null, 2));
